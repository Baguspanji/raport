	...
	<div class="col-md-4">
		<div class="card">
			...
			<div class="card-content">
				<div class="card-body">
					<?php echo form_open_multipart('guru/import', array('name' => 'spreadsheet')); ?>
		...
		<div class="card">
			<div class="card-header pr-5 pl-5 mt-2">
				<div class="row justify-content-between">
					...
					<div>
						<a href="<?= base_url() ?>guru/add_cart" class="btn btn-primary btn-sm"><i class="fas fa-plus-circle"></i> Tambah Data</a>
					</div>
				</div>
			</div>
			<div class="card-content">
